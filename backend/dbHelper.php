...
class dbHelper {
    ...
    function add_project($title,$sum, $desc,$lang,$imp,$fun,$link) {
        ...
        $query = "INSERT INTO projects (title, summary, fullDesc, lang, link, imp, fun) 
                  VALUES ('$title','$sum','$desc','$lang','$link','$imp','$fun');";
    ...
    function delete_feedback($email)
    {
            // Prepare the SQL statement
        $query = "DELETE FROM feedback WHERE  user = :email";
